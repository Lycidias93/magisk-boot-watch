...
ui_print "********************************"
ui_print " Boot Watch Collector v0.2.5-test.1"
ui_print "********************************"
...
ui_print "- v0.2.5-test.1: extended module runtime logs test prerelease"
ui_print "- Extended profile: Frosty logs and LSPosed/lspd log.old bounded tails"
ui_print "- Stable update channel remains v0.2.4; install this test ZIP manually"
