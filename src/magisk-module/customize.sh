...
ui_print "********************************"
ui_print " Boot Watch Collector v0.2.10-webui-runtime-root-hotfix"
ui_print "********************************"
...
ui_print "- v0.2.10: WebUI runtime-root and result-prefix hotfix"
ui_print "- Keeps WebUI run history aligned with pixel_local__boot-watch result files"
ui_print "- Stable update channel promotes v0.2.6"
...
set_perm "$MODPATH/tools/boot-watch-webui-log-export.sh" 0 0 0755
set_perm "$MODPATH/tools/boot-watch-webui-status-export.sh" 0 0 0755
set_perm "$MODPATH/tools/action.original-before-webui-wrapper.sh" 0 0 0755
